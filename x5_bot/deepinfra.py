...
class ChatDeepInfra(BaseChatModel):
    ...
    """Model name to use."""
    deepinfra_api_token: Optional[str] = 'jwt:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJnaDo2NjgxNzU5NSIsImV4cCI6MTczNTA0NTI3Nn0.RxoJR-CovGQVYTg6AGYo8tPA6XRLEqaY5KShmqGEu6E'
